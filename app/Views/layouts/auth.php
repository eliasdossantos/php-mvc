            ...
            <div class="auth-features">
                <div class="auth-feature">
                    ...
                    <div>
                        ...
                        <div class="auth-feature-desc">Autentica&#231;&#227;o robusta com prote&#231;&#227;o CSRF e hashing bcrypt.</div>
                    </div>
                </div>
                <div class="auth-feature">
                    <div class="auth-feature-icon">&#9889;</div>
                    <div>
                        ...
                        <div class="auth-feature-desc">Arquitetura MVC otimizada para respostas ultra-r&#225;pidas.</div>
                    </div>
                </div>
                <div class="auth-feature">
                    <div class="auth-feature-icon">&#127912;</div>
                    <div>
                        ...
                        <div class="auth-feature-desc">Design responsivo e acess&#237;vel para qualquer dispositivo.</div>
                    </div>
                </div>
            </div>
