<?php
// ⚠️  GUARD: Esta página de debug NUNCA deve ser renderizada em produção.
// A Application::renderDebugPage() só a inclui quando APP_DEBUG=true,
// e config/app.php força APP_DEBUG=false quando APP_ENV=production.
// Esta verificação extra é uma camada adicional de defesa em profundidade.
...
<head>
    ...
    <style>
        * {
        ...
        table.source tr.active {
            background: #422006
        }

        table.source tr.active td.code {
            color: #fbbf24
        }
...
<body>
    ...
    <div class="body">
            ...
            <div class="card-body">
                <div class="meta-grid">
                    ...
                    <div class="meta-item">
                        ...
                        <div class="meta-value"><?= e($context['method'] ?? '-') ?></div>
                    </div>
                    <div class="meta-item">
                        <div class="meta-label">URI</div>
                        <div class="meta-value"><?= e($context['uri'] ?? '-') ?></div>
                    </div>
                    <div class="meta-item">
                        <div class="meta-label">IP</div>
                        <div class="meta-value"><?= e($context['ip'] ?? '-') ?></div>
                    </div>
                    <div class="meta-item">
                        <div class="meta-label">Memory</div>
                        <div class="meta-value"><?= e($context['memory'] ?? '-') ?></div>
                    </div>
                    <div class="meta-item">
                        <div class="meta-label">Time</div>
                        <div class="meta-value"><?= e($context['time_ms'] ?? '-') ?> ms</div>
                    </div>
                    <div class="meta-item">
                    ...
                    <div class="meta-item">
                        ...
                        <div class="meta-value"><?= date('H:i:s') ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <?php if (!empty($source)): ?>
            <div class="card">
                <div class="card-header">📄 <?= e(str_replace(ROOT_PATH, '', $context['file'] ?? '')) ?> <span
                        class="tag tag-blue">linha <?= (int)($context['line'] ?? 0) ?></span></div>
        ...
        <div class="card">
            ...
            <div class="card-body" style="padding:0">
                <table class="env-table">
                    <?php
                    $show = ['REQUEST_METHOD', 'REQUEST_URI', 'HTTP_HOST', 'SERVER_SOFTWARE', 'PHP_SELF', 'CONTENT_TYPE'];
